...
for run in run_files:
	...
	if run == 16:
		...
		run_files[run]['nerix_160421_1744.root'] = (4.50, 0.345, {2300:[0,1], 3000:[2,3]})
		...
		# 1000 V/cm
		run_files[run]['nerix_160422_1439.root'] = (4.50, 2.356, {2300:[0,1], 3000:[2,3]})
		run_files[run]['nerix_160422_1632.root'] = (4.50, 2.356, {2300:[0,1], 3000:[2,3]})
		...
		run_files[run]['nerix_160519_1557.root'] = (4.50, 1.054, {3500:[0,1], 4500:[2,3]})
