...
void full_matching_loop(int numTrials, double *aS1, double *aS2, double *aEnergy, float photonYield, float chargeYield, float excitonToIonRatio, float g1Value, float extractionEfficiency, float gasGainValue, float gasGainWidth, float speRes, float intrinsicResS1, float intrinsicResS2)
{
	TRandom r3 = TRandom3();
