...
class neriX_analysis:
	...
	def __init__(self, fileToLoad = None, lFilesToLoad = None, degreeSetting = None, cathodeSetting = None, anodeSetting = None):
		...
		if lFilesToLoad != None:
			...
			for currentFile in lFilesToLoad:
				try:
					...
					if lParameters[DEGREE_INDEX] == degreeSetting and lParameters[ANODE_INDEX] == anodeSetting and lParameters[CATHODE_INDEX] == cathodeSetting:
						# settings match so add proper filename with proper path
						if currentFile[0] == 'n' or currentFile[0] == 'c':
							pathToFile = neriX_config.pathToData + 'run_' + str(self.runNumber) + '/' + str(currentFile)
						else:
						...
						print currentFile[-22:] + ' does not have proper settings - skipping...'
				except KeyError:
					print currentFile[-22:] + ' cannot be found in run ' + str(self.runNumber)
			...
			self.T1.SetName('T1_' + str(degreeSetting) + '_' + str(cathodeSetting) + '_' + str(anodeSetting))
			self.T2.SetName('T2_' + str(degreeSetting) + '_' + str(cathodeSetting) + '_' + str(anodeSetting))
			self.T3.SetName('T3_' + str(degreeSetting) + '_' + str(cathodeSetting) + '_' + str(anodeSetting))
			if self.T4:
				self.T4.SetName('T4_' + str(degreeSetting) + '_' + str(cathodeSetting) + '_' + str(anodeSetting))
			...
			self.filename = str(degreeSetting) + '_' + str(cathodeSetting) + '_' + str(anodeSetting)
